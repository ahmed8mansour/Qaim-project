    ...
    <div className="contact_section">
        <div className="contact_container container main_font">
            <div className='row'>
                ...
                <div className="contact_right col-lg-6 col-12 mt-lg-0 mt-4">
                    <ContactMap/>
                </div>
            </div>
        </div>
